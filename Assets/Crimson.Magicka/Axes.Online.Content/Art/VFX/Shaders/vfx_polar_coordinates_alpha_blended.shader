Shader "VFX/Polar Coord/Masked Alpha Blended" {
    Properties {
	[Header(Textures)]
    ...
    SubShader {
		...
		half4 mask = tex2D(_MaskTex, i.uv0.xy);
                ...
                tex.a = tex.r * mask.r;
                tex.rgb = lerp(1.0, tex.a, _AlphaPremultiplyAmount) * i.vertexColor.rgb;
		tex.a = saturate(tex.a * i.vertexColor.a * _AlphaHardiness);
                return tex;
            }
            ENDCG
        }
