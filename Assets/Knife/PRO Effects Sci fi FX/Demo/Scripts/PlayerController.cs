...
{
    /// <summary>
    /// Simple player controller with run, jump and crouching, demo only
    /// </summary>
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public void Freeze(bool value)
        {
            ...
            var weapons = GetComponentsInChildren<IWeapon>(true);
        ...
        void move()
        {
            ...
            Physics.SphereCast(r, characterCollider.radius, out hitInfo, characterCollider.height / 2f, GroundLayer);
        ...
        void standStateChange()
        {
            ...
            characterCollider.height = Mathf.Lerp(
            ...
            Vector3 colliderCenter = characterCollider.center;
            ...
            controller.height = characterCollider.height;
            controller.center = characterCollider.center;
