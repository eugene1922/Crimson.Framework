...
namespace Crimson.Core.Components
{
	...
	{
		[ShowIf(nameof(inputSource), InputSource.AIInput)]
		[InfoBox("Additional AI Ability Component is needed to use AI Input")]
		[ValidateInput(nameof(MustBeAI), "AI MonoBehaviour must exist and derive from IAISettings!")]
		...
		[ShowIfGroup(nameof(inputSource), InputSource.UserInput)]
		...
		{
			if (!customBindings.Contains(binding))
			{
